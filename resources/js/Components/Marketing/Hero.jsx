                    ...
                    <div className="relative z-0 w-full mt-8">
                        <div className="relative overflow-hidden shadow-2xl">
                            <div className="flex items-center flex-none px-4 bg-green-400 rounded-b-none h-11 rounded-xl"
                                 data-primary="green-400" data-rounded="rounded-xl" data-rounded-max="rounded-full"
                            >
                            ...
                            <img src="https://cdn.devdojo.com/images/march2021/green-dashboard.jpg" alt="Dashboard"/>
                        </div>
                    </div>
                </div>
            </div>
